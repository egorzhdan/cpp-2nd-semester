...
### `MOV`
Самая простая команда, принимает источник и назначение и копирует значение.
...
Записывает 32-битный результат, разбивая на два 16-битных регистра – старшую часть в DX, младшую в AX.

Различные команды для знаковых и беззнаковых типов: `MUL` для беззнаковых, `IMUL` для знаковых.
